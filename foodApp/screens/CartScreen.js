  ...
  return (
    <View className="bg-white flex-1">
      ...
      <View className="relative py-4 shadow-sm">
        ...
        <View>
          <Text className="text-center font-extrabold text-xl ">Your Cart</Text>
          <Text className="text-center text-gray-800 ">{restaurant.name}</Text>
        </View>
      </View>
      {/**Delivery Time */}
      <View
      ...
      >
        ...
        />
        <Text className="flex-1 pl-4 text-blue-700">
          Delver in 20-30 minutes
        </Text>
        <TouchableOpacity>
      ...
      >
        ...
        <View>
            ...
            className="p-3 rounded-full">
                <Text className="text-black text-center font-bold text-lg">Place Order</Text>
            </TouchableOpacity>
        </View>
